...
def test_non_writable_input_is_dealt_with_like_invalid_input(web_fixture):
    ...
    browser.post(fixture.form.event_channel.get_url().path, {'event.an_event?':'', 'field_name': 'illigitimate value', '_reahl_client_concurrency_digest':'', '_reahl_database_concurrency_digest':''})
...
def test_non_writable_events_are_dealt_with_like_invalid_input(web_fixture):
    ...
    browser.post(fixture.form.event_channel.get_url().path, {'event.an_event?':'', '_reahl_client_concurrency_digest':'', '_reahl_database_concurrency_digest':''})
    browser.follow_response()
