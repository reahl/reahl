...
def test_non_writable_input_is_dealt_with_like_invalid_input(web_fixture):
    ...
    browser.post(fixture.form.event_channel.get_url().path, {'event.some_form-an_event?':'', 'field_name': 'illigitimate value', 'some_form-_reahl_concurrency_hash':''})
...
def test_non_writable_events_are_dealt_with_like_invalid_input(web_fixture):
    ...
    browser.post(fixture.form.event_channel.get_url().path, {'event.some_form-an_event?':'', 'some_form-_reahl_concurrency_hash':''})
    browser.follow_response()
