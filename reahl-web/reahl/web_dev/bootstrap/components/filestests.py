...
def prevent_duplicate_upload_js(fixture):
    ...
    error_locator = XPath.error_span_containing('uploaded files should all have different names')
...
def async_validation(fixture):
    ...
    vassert( not fixture.uploaded_file_is_listed( fixture.invalid_file.name ) )
    vassert( browser.is_element_present(XPath.error_span_containing(fixture.validation_error_message)) )
