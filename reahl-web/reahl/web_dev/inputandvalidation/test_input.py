...
class InputScenarios(SimpleInputFixture):
    ...
    def text_input(self):
        ...
        self.expected_html = '<input name="test.an_attribute" form="test" type="text" value="field value" class="reahl-primitiveinput reahl-textinput">'
    ...
    def text_input_placeholder_default(self):
        ...
        self.expected_html = '<input name="test.an_attribute" aria-label="the label" form="test" placeholder="the label" type="text" value="field value" class="reahl-primitiveinput reahl-textinput">'
        self.field_controls_visibility = True

    @scenario
    def text_input_placeholder_specified(self):
        self.widget = TextInput(self.form, self.field, placeholder="some text")
        self.expected_html = '<input name="test.an_attribute" aria-label="some text" form="test" placeholder="some text" type="text" value="field value" class="reahl-primitiveinput reahl-textinput">'
        self.field_controls_visibility = True
    ...
    def button_input(self):
        ...
        self.expected_html = '<input name="event.test.aname?" form="test" type="submit" value="click me" class="reahl-primitiveinput">'
        self.field_controls_visibility = False

    @scenario
    def password(self):
        self.widget = self.form.add_child(PasswordInput(self.form, self.field))
        self.expected_html = '<input name="test.an_attribute" form="test" type="password" class="reahl-primitiveinput">'
        self.field_controls_visibility = True
    ...
    def checkbox_true(self):
        ...
        self.expected_html = '<input name="test.an_attribute" checked="checked" data-false-boolean-value="off" data-is-boolean="" data-msg-required="my text is needed here" data-true-boolean-value="on" form="test" required="*" type="checkbox" class="reahl-primitiveinput">'

    @scenario
    def checkbox_false(self):
        self.setup_checkbox_scenario(False)
        self.expected_html = '<input name="test.an_attribute" data-false-boolean-value="off" data-is-boolean="" data-msg-required="my text is needed here" data-true-boolean-value="on" form="test" required="*" type="checkbox" class="reahl-primitiveinput">'

    @scenario
    def text_area_input(self):
        self.widget = self.form.add_child(TextArea(self.form, self.field, rows=30, columns=20))
        self.expected_html = '<textarea name="test.an_attribute" cols="20" rows="30" class="reahl-primitiveinput">field value</textarea>'
        self.field_controls_visibility = True
    ...
    def select_input(self):
        ...
        self.expected_html = r'<select name="test.an_attribute" form="test" class="reahl-primitiveinput">%s%s</select>' % (option, group)
        self.field_controls_visibility = True
    ...
    def select_input_multi(self):
        ...
        self.expected_html = '<select name="test.an_attribute[]" form="test" multiple="multiple" class="reahl-primitiveinput">%s</select>' % (options)
        self.field_controls_visibility = True
    ...
    def checkbox_input_multi(self):
        ...
        not_checked_option = r'<label><input name="test.an_attribute[]" form="test" type="checkbox" value="1">One</label>'
        checked_options = r'<label><input name="test.an_attribute[]" checked="checked" form="test" type="checkbox" value="2">Two</label>'
        checked_options += r'<label><input name="test.an_attribute[]" checked="checked" form="test" type="checkbox" value="3">Three</label>'
    ...
    def radio_button(self):
        ...
        radio_button = '<label>'\
                       '<input name="test.an_attribute"%s '\
