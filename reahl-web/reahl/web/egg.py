...
from reahl.web.libraries import LibraryIndex, JQuery, JQueryUI, Pure, HTML5Shiv, IE9, Reahl, Holder
from reahl.web.attic.libraries import ReahlAttic
...
class WebConfig(Configuration):
    ...
    def __init__(self):
        ...
        self.frontend_libraries = LibraryIndex(JQuery(), JQueryUI(), Pure(), HTML5Shiv(), IE9(), Reahl(), Holder(), ReahlAttic())
