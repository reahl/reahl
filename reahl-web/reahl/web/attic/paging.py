...
from reahl.web.pager import PageIndexProtocol
from reahl.web.ui import Div, HTMLWidget, A
from reahl.web.attic.layout import HorizontalLayout
from reahl.web.attic.menu import Menu


#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:PagedPanel
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:Page instead
class Page(object):
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:PageIndex instead
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:SequentialPageIndex
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:PageMenu
class PageMenu(HTMLWidget):
    """An Menu, which lists the pages of items that can be navigated by a user. If there are
       ...
       :kwarg menu_layout: The :class:`reahl.web.fw.Layout` to use for the Menu (See :class:`Menu`)
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:AnnualItemOrganiserProtocol
...
#AppliedPendingMove: In future this class may be renamed to: reahl.web.attic.paging:AnnualPageIndex instead
