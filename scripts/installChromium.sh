...
if [ ! -e $HOME/testdownloads/chromium-50.0.2661.0.zip ]; then
    wget -O $HOME/testdownloads/chromium-50.0.2661.0.zip 'https://www.googleapis.com/download/storage/v1/b/chromium-browser-snapshots/o/Linux_x64%2F378083%2Fchrome-linux.zip?generation=1456540849047000&alt=media'
fi 
...
if [ ! -e $HOME/testdownloads/chromedriver-2.22.zip ]; then
    wget -O $HOME/testdownloads/chromedriver-2.22.zip http://chromedriver.storage.googleapis.com/2.22/chromedriver_linux64.zip 
fi
