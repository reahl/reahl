...
class InvestmentOrder(Base):
    ...
    allocations     = relationship('dynamiccontenterrors.Allocation', back_populates='investment_order', lazy='immediate')
...
class Allocation(Base):
    ...
    investment_order  = relationship('dynamiccontenterrors.InvestmentOrder', back_populates='allocations')
