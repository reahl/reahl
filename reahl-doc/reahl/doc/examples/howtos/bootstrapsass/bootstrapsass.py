...
class InvestmentOrder(Base):
    ...
    allocations     = relationship('bootstrapsass.Allocation', back_populates='investment_order', lazy='immediate')
    id_document     = relationship('bootstrapsass.IDDocument', uselist=False, back_populates='investment_order')
...
class Allocation(Base):
    ...
    investment_order  = relationship('bootstrapsass.InvestmentOrder', back_populates='allocations')
...
class IDDocument(Base):
    ...
    investment_id = Column(Integer, ForeignKey(InvestmentOrder.id))
    investment_order  = relationship('bootstrapsass.InvestmentOrder', back_populates='id_document')
