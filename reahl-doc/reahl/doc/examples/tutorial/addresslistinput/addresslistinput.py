...
from reahl.web.bootstrap.forms import TextInput, Form, FormLayout, ButtonInput, ButtonLayout
...
class AddressForm(Form):
    def __init__(self, view):
        ...
        self.layout.add_input(TextInput(self, model_object.fields.name, placeholder='...name'))
        self.layout.add_input(TextInput(self, model_object.fields.email_address, placeholder='email'))

        self.define_event_handler(model_object.events.save)
        btn = self.add_child(ButtonInput(self, model_object.events.save))
