# To run this test do:
# pytest --pyargs reahl.doc.examples.tutorial.addresslistinput.addresslistinput_dev.test_addresslist
# or
# reahl unit
#
# To set up a demo database for playing with, do:
# pytest -o python_functions=demo_setup --pyargs reahl.doc.examples.tutorial.addresslistinput.addresslistinput_dev.test_addresslist
# or
# reahl demosetup
...
from reahl.doc.examples.tutorial.addresslistinput.addresslistinput import Address
