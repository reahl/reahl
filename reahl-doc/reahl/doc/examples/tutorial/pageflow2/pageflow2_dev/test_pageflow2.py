# To run this test do:
# pytest --pyargs reahl.doc.examples.tutorial.pageflow2.pageflow2_dev.test_pageflow2
# or
# reahl unit
#
# To set up a demo database for playing with, do:
# pytest -o python_functions=demo_setup --pyargs reahl.doc.examples.tutorial.pageflow2.pageflow2_dev.test_pageflow2
# or
# reahl demosetup
...
from reahl.doc.examples.tutorial.pageflow2.pageflow2 import Address
