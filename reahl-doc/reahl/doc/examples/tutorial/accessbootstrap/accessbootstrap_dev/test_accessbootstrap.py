...
class AccessUIFixture(Fixture):
    def __init__(self, web_fixture):
        super(AccessUIFixture, self).__init__()
...
access_ui_fixture = AccessUIFixture.as_pytest_fixture()
...
class ViewScenarios(Fixture):
    def __init__(self, sql_alchemy_fixture, access_domain_fixture):
        super(ViewScenarios, self).__init__()
        self.context = sql_alchemy_fixture.context
        self.access_domain_fixture = access_domain_fixture
...
view_scenarios = ViewScenarios.as_pytest_fixture()
