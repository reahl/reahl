...
from reahl.doc.examples.tutorial.accessbootstrap.accessbootstrap import Address
from reahl.doc.examples.tutorial.accessbootstrap.accessbootstrap import AddressBook
from reahl.doc.examples.tutorial.accessbootstrap.accessbootstrap import AddressBookUI
from reahl.domain.systemaccountmodel import EmailAndPasswordSystemAccount

# To run this test do:
# nosetests reahl.doc.examples.tutorial.accessbootstrap.accessbootstrap_dev.accessbootstraptests
#
# To set up a demo database for playing with, do:
# nosetests -F reahl.webdev.fixtures:BrowserSetup --with-setup-fixture=reahl.doc.examples.tutorial.accessbootstrap.accessbootstrap_dev.accessbootstraptests:DemoFixture -s --nologcapture
