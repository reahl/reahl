...
from reahl.doc.examples.tutorial.addressbook2bootstrap.addressbook2bootstrap import Address, AddressBookUI

# To set up a demo database for playing with, do:
# nosetests -F reahl.webdev.fixtures:BrowserSetup --with-setup-fixture=reahl.doc.examples.tutorial.addressbook2bootstrap.addressbook2bootstrap_dev.addressbook2bootstraptests:DemoFixture -s --nologcapture
# or
# reahl demosetup
