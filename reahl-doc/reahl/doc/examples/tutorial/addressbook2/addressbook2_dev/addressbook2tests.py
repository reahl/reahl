...
# nosetests -F reahl.webdev.fixtures:BrowserSetup --with-setup-fixture=reahl.doc.examples.tutorial.addressbook2.addressbook2_dev.addressbook2tests:DemoFixture -s --nologcapture
# or
# reahl demosetup
