...
page, you have to instantiate a Catalogue at the top of a module and
assign it to the variable named `_`. Each translatable string is then
marked using a call to the Catalogue.
...
Note that the Catalogue instance is created for the `reahl-doc`
