...
In order to see the changes in a development environment, you can
change `web.config.py' to force your `CompiledBootstrap` to display a
...
.. note::
   ...
   localhost to your local `hosts` file.
