...
class EggProject(Project):
    ...
    def generate_setup_py(self):
        with io.open(self.setup_py_filename, 'w') as setup_file:
            ...
            setup_file.write('        print("XXX: %s")\n' % str(self.test_deps_for_setup()))
            setup_file.write("        if self.distribution.tests_require: easy_install.main(['-U']+self.distribution.tests_require)\n")
            setup_file.write('\n')
