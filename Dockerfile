...
RUN bash -l -c "cd $REAHL_SCRIPTS && python scripts/bootstrap.py --script-dependencies && python scripts/bootstrap.py --bootstrap-core-projects && python scripts/bootstrap.py --pip-installs && reahl shell -sdX python -m pip install --no-deps -e ."
